    ...
    <div style="width:100%">
      <div class="cont_search">
        ...
        <input
          class="searchword"
          type="text"
          v-model="submit.searchword"
          placeholder="请输入关键词"
          onfocus="this.placeholder=''"
          onblur="this.placeholder='请输入关键词'"
        />
        <el-date-picker
          value-format="yyyyMMdd"
          v-model="submit.searchTime"
          type="daterange"
          align="right"
          unlink-panels
          range-separator="至"
        ...
        <input
          type="text"
          class="min"
          v-model="submit.startreprints"
          placeholder="最小影响力"
          onfocus="this.placeholder=''"
          onblur="this.placeholder='最小影响力'"
        />
        <span>至</span>
        <input
          type="text"
          class="max"
          v-model="submit.endreprints"
          placeholder="最大影响力"
          onfocus="this.placeholder=''"
          onblur="this.placeholder='最大影响力'"
        />
        <button
          class="btn2"
          @click="getAll"
          :class=" (submit.startreprints !='' ||submit.endreprints !='') ? 'empty':''"
        >全部</button>
